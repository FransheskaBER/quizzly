...
- **Single source of truth**: All design tokens (colors, typography, spacing, radii, shadows, transitions, component tokens) live in `packages/client/src/styles/global.css`.
