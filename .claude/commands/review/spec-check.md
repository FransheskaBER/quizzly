...
- **Lesson learned**: what rule or note should be added to CLAUDE.md, implementation-mode rules, or future specs to prevent this. Be specific: "Add to CLAUDE.md: 'Always validate X before Y'" — not "be more careful."
...
- [Specific rule or note for CLAUDE.md or future specs]
- [Another lesson]
- ...
...
4. If code fixes are needed: tell the user: "Hand the Deviations section of REVIEW.md to Claude Code as the implementation brief for fixes."
5. If lessons learned include CLAUDE.md updates: tell the user: "Add these rules to CLAUDE.md or `.claude/rules/` to prevent recurrence."
