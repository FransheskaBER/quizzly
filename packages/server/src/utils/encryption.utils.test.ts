...
describe('encrypt', () => {
  it('returns a base64-encoded string', () => {
    const ciphertext = encrypt('sk-ant-test-nonsecret-key-1234567890');
  ...
  it('produces different ciphertexts for the same plaintext (random IV)', () => {
    const plaintext = 'sk-ant-test-nonsecret-key-1234567890';
...
describe('decrypt', () => {
  it('recovers the original plaintext', () => {
    const plaintext = 'sk-ant-test-nonsecret-validation-1234567890';
